...
export default class extends Command {
  ...
  async exec(message: Message, args: string[]) {
    ...
    message.channel.createMessage({
      content: Math.random() > .7 ? 'You can now **vote** for **COVID-19 Bot** here: <https://top.gg/bot/685268214435020809/vote>, feel free to join our server also: <https://discord.gg/EvbMshU>' : null,
      embed: {
        author: {
